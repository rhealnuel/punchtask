  ...
  return (
    <div className='bg-[#0C0C0C] ' >
        <div className='w-screen h-full py-20 flex flex-col items-center'>
            ...
            <div className='pt-52 pb-36 grid lg:grid-cols-3 lg:px-10 gap-x-10 lg:items-start items-center' data-aos="fade-right">
                ...
                <div className=' lg:col-span-2 flex flex-col gap-20' data-aos="fade-left">
                    <div >
