  ...
  return (
    <div className='' >
        <div className=' mt-[40px] h-fit py-[190px] bg-[#202229] text-white flex flex-col lg:flex-row items-center justify-between  lg:pl-10 lg:pr-[229px]   '>
            {/*first section  */}
            <div className='flex flex-col gap-6 lg:gap-16 items-center lg:items-start  pb-28 ' data-aos="fade-up-right">
...
{/* second section */}
            ...
            <div className='flex flex-col gap-8 lg:gap-12 items-center lg:items-start' data-aos="fade-down-left">
